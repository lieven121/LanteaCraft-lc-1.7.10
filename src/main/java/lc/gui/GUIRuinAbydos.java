 ...
 *
 */
public class GUIRuinAbydos extends LCContainerGUI {
	...
	public static class StargateDefaultTab extends LCContainerTab {
		...
		protected void drawBackgroundLayer(LCContainerGUI container, float partialTickCount, int mouseX, int mouseY) {
			container.bindTexture(ResourceAccess.getNamedResource(ResourceAccess
					.formatResourceName("textures/gui/prefabs/blank_gui_${TEX_QUALITY}.png")), 256, 256);
		...
		protected void drawForegroundLayer(LCContainerGUI container, int mouseX, int mouseY) {
			...
			/*IconButton.drawButton(Minecraft.getMinecraft(), "copy", 230, 54, mouseX - container.offsetLeft()-10, mouseY
					- container.offsetTop(), container.isMouseDown(), 0.75, 1.0f); //TODO add back 
	 ...
	 *            The local player
	 */
	public GUIRuinAbydos(TileStargateBase tile, EntityPlayer player) {
