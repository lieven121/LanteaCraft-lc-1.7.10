 ...
 *
 */
@Definition(name = "blockLanteaOre", type = ComponentType.CORE, blockClass = BlockLanteaGlass.class, itemBlockClass = ItemBlockLanteaOre.class)
public class BlockLanteaGlass extends LCBlock {
	private IIcon missing;

	/** Default constructor */
	public BlockLanteaGlass() {
