 ...
 *
 */
@Definition(name = "Ruins", type = ComponentType.WORLDGEN, blockClass = BlockRuinGateAddress.class, itemBlockClass = ItemBlockDHD.class, tileClass = TileDHD.class)
public class BlockRuinGateAddress extends LCBlock {
	...
	public IBlockRenderInfo renderInfoBlock() {
		return BlockRuinGateAddress.renderInfo;
	}
